...
| `/learn-list <topic> [--mode quick\|standard\|deep]` | Turns any topic into a verified, anti-slop, multi-format curated reading list — organized by a canon-derived topic outline, every link fetched and verified before it ships, each ranked and annotated with a ≤2-sentence why, closing with a follow-list of people, newsletters, books (with summaries) and practitioners' signature writings plus a copy-ready paste-block. Verification-first; effort scales by mode. |
