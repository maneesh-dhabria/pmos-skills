#!/usr/bin/env bash
# T19 — entrypoint wrapper for /prototype apply-edit-at-anchor contract test.
...
exec node plugins/pmos-toolkit/skills/prototype/tests/apply-edit-at-anchor.test.js
