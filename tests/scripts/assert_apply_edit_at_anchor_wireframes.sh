#!/usr/bin/env bash
# T19 — entrypoint wrapper for /wireframes apply-edit-at-anchor contract test.
...
exec node plugins/pmos-toolkit/skills/wireframes/tests/apply-edit-at-anchor.test.js
