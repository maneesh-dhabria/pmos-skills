#!/usr/bin/env bash
# T10 inline verification — /comments resolver confirm-each happy path.
# Refs: FR-20, FR-22, FR-24, FR-27, FR-28, FR-31; §6.1, §9.1, §9.3.
set -euo pipefail
...
TEST="$REPO/plugins/pmos-toolkit/skills/comments/tests/resolver-confirm-each.test.js"
if [ ! -f "$TEST" ]; then
