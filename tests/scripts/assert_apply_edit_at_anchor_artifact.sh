#!/usr/bin/env bash
# T18 — entrypoint wrapper for /artifact's apply-edit-at-anchor contract test.
...
exec node plugins/pmos-toolkit/skills/artifact/tests/apply-edit-at-anchor.test.js
