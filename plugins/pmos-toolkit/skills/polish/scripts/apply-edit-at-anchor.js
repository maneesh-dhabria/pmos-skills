#!/usr/bin/env node
// T21 — /polish "Apply comment-resolver edit" Node-callable shim.
//
...
// /polish's per-skill apply-edit phase. Surface area kept ≤ ~200 LOC.
...
async function apply(input) {
  try {
    ...
    const annotation = `<!-- comment-resolver: thread=${input.thread_id} skill=polish request="${bodyExcerpt}" -->\n`;
