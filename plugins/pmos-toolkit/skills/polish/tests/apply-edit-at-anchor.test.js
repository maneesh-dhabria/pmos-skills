#!/usr/bin/env node
// T21 — per-skill contract test for /polish's "Apply comment-resolver edit" shim.
...
const FIXTURE = path.join(__dirname, "fixtures", "apply-edit-at-anchor", "polish_mini.html");
  ...
  return Object.assign(
    {
      ...
      thread_id: "T_A",
      anchor: { id_anchor: "voice", quote_anchor: null },
...
(async () => {
  ...
  if (failures.length > 0) {
    console.error("FAIL: /polish apply-edit-at-anchor — " + failures.length + " of 5 cases");
    for (const f of failures) console.error("  - " + f);
    process.exit(1);
  }
  console.log("PASS: /polish apply-edit-at-anchor — 5 cases");
})().catch((e) => {
