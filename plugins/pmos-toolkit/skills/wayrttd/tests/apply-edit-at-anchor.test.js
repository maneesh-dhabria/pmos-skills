#!/usr/bin/env node
// T4 — per-skill contract test for /wayrttd's "Apply comment-resolver edit" shim.
...
const FIXTURE = path.join(__dirname, "fixtures", "apply-edit-at-anchor", "wayrttd_mini.html");
  ...
  return Object.assign(
    {
      ...
      thread_id: "T_A",
      anchor: { id_anchor: "solution-x", quote_anchor: null },
...
(async () => {
  ...
  if (failures.length > 0) {
    console.error("FAIL: /wayrttd apply-edit-at-anchor — " + failures.length + " of 5 cases");
    for (const f of failures) console.error("  - " + f);
    process.exit(1);
  }
  console.log("PASS: /wayrttd apply-edit-at-anchor — 5 cases");
})().catch((e) => {
