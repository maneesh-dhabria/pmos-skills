import { GENERIC_FONTS } from './constants.mjs';
import { isNeutralColor } from './color.mjs';
...
import { profileFindings, profileStep } from './profiler.mjs';
...
function detectText(content, filePath, options = {}) {
  ...
  // Inline `pmos-slop-disable*` waivers travel with the file; honor them unless
