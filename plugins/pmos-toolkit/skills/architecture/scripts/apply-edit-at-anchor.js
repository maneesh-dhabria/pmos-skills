#!/usr/bin/env node
// T21 — /architecture "Apply comment-resolver edit" Node-callable shim.
//
...
// /architecture's per-skill apply-edit phase. Surface area kept ≤ ~200 LOC.
...
async function apply(input) {
  try {
    ...
    const annotation = `<!-- comment-resolver: thread=${input.thread_id} skill=architecture request="${bodyExcerpt}" -->\n`;
