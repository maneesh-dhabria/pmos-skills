#!/usr/bin/env node
// T21 — /readme "Apply comment-resolver edit" Node-callable shim.
//
...
// /readme's per-skill apply-edit phase. Surface area kept ≤ ~200 LOC.
...
async function apply(input) {
  try {
    ...
    const annotation = `<!-- comment-resolver: thread=${input.thread_id} skill=readme request="${bodyExcerpt}" -->\n`;
