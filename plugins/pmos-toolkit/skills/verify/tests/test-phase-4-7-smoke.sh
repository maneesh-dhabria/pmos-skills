#!/usr/bin/env bash
# test-phase-4-7-smoke.sh — T13 unit smoke for /verify Phase 4b (folded /architecture --since).
#
# Five grep assertions per plan §T13 step 2:
#   (1) SKILL.md has the literal Phase 4b heading
#   (2) SKILL.md mentions --skip-folded-arch
#   (3) Phase 4b body references folded_phase_failures
#   (4) Phase 4b body wires git merge-base HEAD main as the --since base
