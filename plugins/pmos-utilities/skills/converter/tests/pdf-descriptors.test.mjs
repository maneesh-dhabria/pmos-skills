...
// After epic 260617-vvd merges all three stories, the registry carries the foundation
// (4 data ids) + the HTML↔MD pair (260617-rck) + this PDF↔MD pair (260617-ade).
check('auto-discovery registered the 8 ids (4 data + HTML↔MD + PDF↔MD pairs)',
  eq(ids, ['csv→json', 'html→md', 'json→csv', 'json→yaml', 'md→html', 'md→pdf', 'pdf→md', 'yaml→json']));
