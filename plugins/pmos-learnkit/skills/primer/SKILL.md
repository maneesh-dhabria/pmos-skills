...
Re-runnable + convergent (INV-5): a second run over an already-enriched primer dedups by verbatim url and adds nothing it cannot verify — no duplicate sources, no runaway growth. The corpus backfill over all 61 primers is story `260704-e3b`, which imports this engine.
